...
asn_enc_rval_t
CSG_Identity_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	CSG_Identity_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
CSG_Identity_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	CSG_Identity_1_inherit_TYPE_descriptor(td);
...
static ber_tlv_tag_t asn_DEF_CSG_Identity_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_CSG_Identity = {
	...
	CSG_Identity_decode_aper,
	CSG_Identity_encode_aper,
