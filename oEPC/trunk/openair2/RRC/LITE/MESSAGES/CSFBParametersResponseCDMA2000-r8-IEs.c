...
static asn_TYPE_member_t asn_MBR_CSFBParametersResponseCDMA2000_r8_IEs_1[] = {
...
static int asn_MAP_CSFBParametersResponseCDMA2000_r8_IEs_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_CSFBParametersResponseCDMA2000_r8_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CSFBParametersResponseCDMA2000_r8_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rand at 218 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* mobilityParameters at 219 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtension at 220 */
};
