...
static asn_TYPE_member_t asn_MBR_UL_UM_RLC_1[] = {
...
static ber_tlv_tag_t asn_DEF_UL_UM_RLC_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UL_UM_RLC_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* sn-FieldLength at 2553 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UL_UM_RLC_specs_1 = {
