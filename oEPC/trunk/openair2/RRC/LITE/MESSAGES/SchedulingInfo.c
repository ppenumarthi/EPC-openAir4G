...
static asn_enc_rval_t
si_Periodicity_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	si_Periodicity_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
si_Periodicity_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	si_Periodicity_2_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_si_Periodicity_2 = {
	...
	si_Periodicity_2_decode_aper,
	si_Periodicity_2_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_SchedulingInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* si-Periodicity at 1215 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* sib-MappingInfo at 1217 */
};
