...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_3 = {
	sizeof(struct UEInformationResponse_v1020_IEs__nonCriticalExtension),
	offsetof(struct UEInformationResponse_v1020_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_UEInformationResponse_v1020_IEs_1[] = {
...
static int asn_MAP_UEInformationResponse_v1020_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UEInformationResponse_v1020_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UEInformationResponse_v1020_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* logMeasReport-r10 at 1335 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension at 1336 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UEInformationResponse_v1020_IEs_specs_1 = {
