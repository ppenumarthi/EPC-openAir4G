...
static int asn_MAP_CellSelectionInfo_v920_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_CellSelectionInfo_v920_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CellSelectionInfo_v920_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* q-QualMin-r9 at 1228 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* q-QualMinOffset-r9 at 1229 */
};
