...
static asn_enc_rval_t
deltaMCS_Enabled_3_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	deltaMCS_Enabled_3_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
deltaMCS_Enabled_3_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	deltaMCS_Enabled_3_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_deltaMCS_Enabled_3 = {
	...
	deltaMCS_Enabled_3_decode_aper,
	deltaMCS_Enabled_3_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_UplinkPowerControlDedicated_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* p0-UE-PUSCH at 2830 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* deltaMCS-Enabled at 2831 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* accumulationEnabled at 2832 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* p0-UE-PUCCH at 2833 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* pSRS-Offset at 2834 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* filterCoefficient at 2835 */
};
