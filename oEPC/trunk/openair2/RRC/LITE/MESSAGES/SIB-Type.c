...
asn_enc_rval_t
SIB_Type_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	SIB_Type_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
SIB_Type_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	SIB_Type_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_SIB_Type = {
	...
	SIB_Type_decode_aper,
	SIB_Type_encode_aper,
