...
static asn_TYPE_member_t asn_MBR_AS_Config_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct AS_Config, sourceSystemInformationBlockType1Ext),
	...
	{ ATF_POINTER, 2, offsetof(struct AS_Config, sourceOtherConfig_r9),
	...
	{ ATF_POINTER, 1, offsetof(struct AS_Config, sourceSCellConfigList_r10),
...
static int asn_MAP_AS_Config_oms_1[] = { 9, 10, 11 };
...
static asn_TYPE_tag2member_t asn_MAP_AS_Config_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* sourceSystemInformationBlockType1Ext at 4269 */
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 }, /* sourceOtherConfig-r9 at 4272 */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 } /* sourceSCellConfigList-r10 at 4273 */
};
