...
static asn_enc_rval_t
dtm_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	dtm_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
dtm_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	dtm_r9_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
e_RedirectionGERAN_r9_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	e_RedirectionGERAN_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
e_RedirectionGERAN_r9_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	e_RedirectionGERAN_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_dtm_r9_2 = {
	...
	dtm_r9_2_decode_aper,
	dtm_r9_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_e_RedirectionGERAN_r9_4 = {
	...
	e_RedirectionGERAN_r9_4_decode_aper,
	e_RedirectionGERAN_r9_4_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_IRAT_ParametersGERAN_v920_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dtm-r9 at 3986 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* e-RedirectionGERAN-r9 at 3987 */
};
