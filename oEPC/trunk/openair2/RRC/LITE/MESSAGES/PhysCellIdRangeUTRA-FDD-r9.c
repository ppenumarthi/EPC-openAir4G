...
static int asn_MAP_PhysCellIdRangeUTRA_FDD_r9_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_PhysCellIdRangeUTRA_FDD_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PhysCellIdRangeUTRA_FDD_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* start-r9 at 3062 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* range-r9 at 3063 */
};
