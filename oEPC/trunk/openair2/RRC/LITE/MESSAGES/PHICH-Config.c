...
static asn_enc_rval_t
phich_Duration_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	phich_Duration_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
phich_Duration_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	phich_Duration_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
phich_Resource_5_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	phich_Resource_5_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
phich_Resource_5_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	phich_Resource_5_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_phich_Duration_2 = {
	...
	phich_Duration_2_decode_aper,
	phich_Duration_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_phich_Resource_5 = {
	...
	phich_Resource_5_decode_aper,
	phich_Resource_5_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_PHICH_Config_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* phich-Duration at 2151 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* phich-Resource at 2152 */
};
