...
static asn_enc_rval_t
targetRAT_Type_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	targetRAT_Type_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
targetRAT_Type_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	targetRAT_Type_2_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_targetRAT_Type_2 = {
	...
	targetRAT_Type_2_decode_aper,
	targetRAT_Type_2_encode_aper,
