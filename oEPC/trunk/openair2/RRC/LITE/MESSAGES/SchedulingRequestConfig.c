...
static asn_enc_rval_t
dsr_TransMax_6_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	dsr_TransMax_6_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
dsr_TransMax_6_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	dsr_TransMax_6_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_dsr_TransMax_6 = {
	...
	dsr_TransMax_6_decode_aper,
	dsr_TransMax_6_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_setup_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sr-PUCCH-ResourceIndex at 2669 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* sr-ConfigIndex at 2670 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dsr-TransMax at 2672 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SchedulingRequestConfig_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release at 2667 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup at 2669 */
};
