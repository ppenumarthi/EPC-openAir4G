...
static asn_enc_rval_t
cqi_Mask_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	cqi_Mask_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
cqi_Mask_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	cqi_Mask_r9_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
pmi_RI_Report_r9_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	pmi_RI_Report_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
pmi_RI_Report_r9_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	pmi_RI_Report_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_cqi_Mask_r9_2 = {
	...
	cqi_Mask_r9_2_decode_aper,
	cqi_Mask_r9_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_pmi_RI_Report_r9_4 = {
	...
	pmi_RI_Report_r9_4_decode_aper,
	pmi_RI_Report_r9_4_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_CQI_ReportConfig_v920_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cqi-Mask-r9 at 1870 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* pmi-RI-Report-r9 at 1871 */
};
