...
static asn_enc_rval_t
hoppingMode_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	hoppingMode_4_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
hoppingMode_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	hoppingMode_4_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_hoppingMode_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_n_SB_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (1..4) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_pusch_HoppingOffset_constr_7 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_hoppingMode_4 = {
	...
	hoppingMode_4_decode_aper,
	hoppingMode_4_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_pusch_ConfigBasic_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* n-SB at 2293 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* hoppingMode at 2294 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* pusch-HoppingOffset at 2295 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* enable64QAM at 2296 */
};
...
static asn_TYPE_tag2member_t asn_MAP_PUSCH_ConfigCommon_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pusch-ConfigBasic at 2293 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ul-ReferenceSignalsPUSCH at 2299 */
};
