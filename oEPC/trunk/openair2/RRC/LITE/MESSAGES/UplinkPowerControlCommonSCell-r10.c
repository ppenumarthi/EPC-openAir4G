...
static asn_enc_rval_t
alpha_r10_3_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	alpha_r10_3_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
alpha_r10_3_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	alpha_r10_3_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_alpha_r10_constr_3 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_alpha_r10_3 = {
	...
	alpha_r10_3_decode_aper,
	alpha_r10_3_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_UplinkPowerControlCommonSCell_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* p0-NominalPUSCH-r10 at 2825 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* alpha-r10 at 2826 */
};
