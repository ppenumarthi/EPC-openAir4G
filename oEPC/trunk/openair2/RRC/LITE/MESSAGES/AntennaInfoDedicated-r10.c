...
static asn_enc_rval_t
transmissionMode_r10_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	transmissionMode_r10_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
transmissionMode_r10_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	transmissionMode_r10_2_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_transmissionMode_r10_2 = {
	...
	transmissionMode_r10_2_decode_aper,
	transmissionMode_r10_2_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_ue_TransmitAntennaSelection_tag2el_20[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release at 1850 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup at 1851 */
};
...
static asn_TYPE_tag2member_t asn_MAP_AntennaInfoDedicated_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transmissionMode-r10 at 1845 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* codebookSubsetRestriction-r10 at 1848 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ue-TransmitAntennaSelection at 1850 */
};
