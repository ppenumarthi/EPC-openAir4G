...
static asn_enc_rval_t
loggedMeasurementsIdle_r10_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	loggedMeasurementsIdle_r10_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
loggedMeasurementsIdle_r10_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	loggedMeasurementsIdle_r10_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
standaloneGNSS_Location_r10_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	standaloneGNSS_Location_r10_4_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
standaloneGNSS_Location_r10_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	standaloneGNSS_Location_r10_4_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_loggedMeasurementsIdle_r10_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_standaloneGNSS_Location_r10_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_loggedMeasurementsIdle_r10_2 = {
	...
	loggedMeasurementsIdle_r10_2_decode_aper,
	loggedMeasurementsIdle_r10_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_standaloneGNSS_Location_r10_4 = {
	...
	standaloneGNSS_Location_r10_4_decode_aper,
	standaloneGNSS_Location_r10_4_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_UE_BasedNetwPerfMeasParameters_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* loggedMeasurementsIdle-r10 at 4039 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* standaloneGNSS-Location-r10 at 4040 */
};
