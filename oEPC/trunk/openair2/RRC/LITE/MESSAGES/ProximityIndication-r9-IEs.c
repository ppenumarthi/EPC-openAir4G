...
static asn_enc_rval_t
type_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	type_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
type_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	type_r9_2_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_type_r9_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_carrierFreq_r9_constr_5 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_type_r9_2 = {
	...
	type_r9_2_decode_aper,
	type_r9_2_encode_aper,
