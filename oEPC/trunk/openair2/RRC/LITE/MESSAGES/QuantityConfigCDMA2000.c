...
static asn_enc_rval_t
measQuantityCDMA2000_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	measQuantityCDMA2000_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
measQuantityCDMA2000_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	measQuantityCDMA2000_2_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_measQuantityCDMA2000_2 = {
	...
	measQuantityCDMA2000_2_decode_aper,
	measQuantityCDMA2000_2_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_QuantityConfigCDMA2000_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* measQuantityCDMA2000 at 3516 */
};
