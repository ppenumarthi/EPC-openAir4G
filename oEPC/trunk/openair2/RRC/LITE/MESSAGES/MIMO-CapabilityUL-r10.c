...
asn_enc_rval_t
MIMO_CapabilityUL_r10_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	MIMO_CapabilityUL_r10_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
MIMO_CapabilityUL_r10_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	MIMO_CapabilityUL_r10_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_MIMO_CapabilityUL_r10_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_MIMO_CapabilityUL_r10 = {
	...
	MIMO_CapabilityUL_r10_decode_aper,
	MIMO_CapabilityUL_r10_encode_aper,
