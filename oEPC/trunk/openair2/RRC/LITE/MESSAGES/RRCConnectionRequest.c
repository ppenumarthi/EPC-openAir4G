...
static asn_TYPE_tag2member_t asn_MAP_criticalExtensions_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionRequest-r8 at 991 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensionsFuture at 992 */
};
static asn_CHOICE_specifics_t asn_SPC_criticalExtensions_specs_2 = {
	sizeof(struct RRCConnectionRequest__criticalExtensions),
	offsetof(struct RRCConnectionRequest__criticalExtensions, _asn_ctx),
	offsetof(struct RRCConnectionRequest__criticalExtensions, present),
	sizeof(((struct RRCConnectionRequest__criticalExtensions *)0)->present),
...
static asn_TYPE_member_t asn_MBR_RRCConnectionRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionRequest, criticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionRequest_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* criticalExtensions at 991 */
};
