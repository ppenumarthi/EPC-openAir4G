...
static asn_enc_rval_t
subframeAssignment_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	subframeAssignment_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
subframeAssignment_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	subframeAssignment_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
specialSubframePatterns_10_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	specialSubframePatterns_10_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
specialSubframePatterns_10_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	specialSubframePatterns_10_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_subframeAssignment_2 = {
	...
	subframeAssignment_2_decode_aper,
	subframeAssignment_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_specialSubframePatterns_10 = {
	...
	specialSubframePatterns_10_decode_aper,
	specialSubframePatterns_10_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_TDD_Config_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* subframeAssignment at 2785 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* specialSubframePatterns at 2787 */
};
