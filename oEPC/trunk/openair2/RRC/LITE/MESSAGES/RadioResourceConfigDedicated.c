...
static asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicated_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicated, rlf_TimersAndConstants_r9),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicated, measSubframePatternPCell_r10),
...
static asn_TYPE_tag2member_t asn_MAP_RadioResourceConfigDedicated_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* rlf-TimersAndConstants-r9 at 2473 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* measSubframePatternPCell-r10 at 2475 */
};
