...
static asn_enc_rval_t
cn_Domain_3_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	cn_Domain_3_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
cn_Domain_3_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	cn_Domain_3_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_cn_Domain_constr_3 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_cn_Domain_3 = {
	...
	cn_Domain_3_decode_aper,
	cn_Domain_3_encode_aper,
