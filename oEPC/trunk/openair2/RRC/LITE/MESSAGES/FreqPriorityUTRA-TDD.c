...
static asn_TYPE_member_t asn_MBR_FreqPriorityUTRA_TDD_1[] = {
...
static ber_tlv_tag_t asn_DEF_FreqPriorityUTRA_TDD_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_FreqPriorityUTRA_TDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* carrierFreq at 940 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellReselectionPriority at 942 */
};
static asn_SEQUENCE_specifics_t asn_SPC_FreqPriorityUTRA_TDD_specs_1 = {
