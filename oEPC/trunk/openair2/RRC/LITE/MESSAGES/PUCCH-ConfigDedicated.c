...
static asn_enc_rval_t
repetitionFactor_5_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	repetitionFactor_5_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
repetitionFactor_5_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	repetitionFactor_5_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
tdd_AckNackFeedbackMode_11_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	tdd_AckNackFeedbackMode_11_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
tdd_AckNackFeedbackMode_11_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	tdd_AckNackFeedbackMode_11_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_repetitionFactor_5 = {
	...
	repetitionFactor_5_decode_aper,
	repetitionFactor_5_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_setup_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* repetitionFactor at 2256 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* n1PUCCH-AN-Rep at 2257 */
};
...
static asn_TYPE_tag2member_t asn_MAP_ackNackRepetition_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release at 2254 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup at 2256 */
};
...
asn_TYPE_descriptor_t asn_DEF_tdd_AckNackFeedbackMode_11 = {
	...
	tdd_AckNackFeedbackMode_11_decode_aper,
	tdd_AckNackFeedbackMode_11_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_PUCCH_ConfigDedicated_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ackNackRepetition at 2254 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd-AckNackFeedbackMode at 2260 */
};
