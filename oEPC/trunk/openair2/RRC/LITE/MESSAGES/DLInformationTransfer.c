...
static asn_TYPE_member_t asn_MBR_c1_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DLInformationTransfer__criticalExtensions__c1, choice.dlInformationTransfer_r8),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DLInformationTransfer__criticalExtensions__c1, choice.spare1),
...
static asn_TYPE_tag2member_t asn_MAP_c1_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dlInformationTransfer-r8 at 233 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* spare3 at 234 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* spare2 at 234 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* spare1 at 234 */
};
static asn_CHOICE_specifics_t asn_SPC_c1_specs_4 = {
	sizeof(struct DLInformationTransfer__criticalExtensions__c1),
	offsetof(struct DLInformationTransfer__criticalExtensions__c1, _asn_ctx),
	offsetof(struct DLInformationTransfer__criticalExtensions__c1, present),
	sizeof(((struct DLInformationTransfer__criticalExtensions__c1 *)0)->present),
	asn_MAP_c1_tag2el_4,
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DLInformationTransfer__criticalExtensions, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DLInformationTransfer__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_criticalExtensions_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* c1 at 233 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensionsFuture at 236 */
};
...
static asn_TYPE_member_t asn_MBR_DLInformationTransfer_1[] = {
...
static ber_tlv_tag_t asn_DEF_DLInformationTransfer_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DLInformationTransfer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrc-TransactionIdentifier at 230 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensions at 235 */
};
static asn_SEQUENCE_specifics_t asn_SPC_DLInformationTransfer_specs_1 = {
