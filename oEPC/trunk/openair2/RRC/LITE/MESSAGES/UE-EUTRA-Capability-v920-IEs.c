...
static asn_enc_rval_t
deviceType_r9_6_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	deviceType_r9_6_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
deviceType_r9_6_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	deviceType_r9_6_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_deviceType_r9_6 = {
	...
	deviceType_r9_6_decode_aper,
	deviceType_r9_6_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_UE_EUTRA_Capability_v920_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* phyLayerParameters-v920 at 3776 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* interRAT-ParametersGERAN-v920 at 3777 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* interRAT-ParametersUTRA-v920 at 3778 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* interRAT-ParametersCDMA2000-v920 at 3779 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* deviceType-r9 at 3780 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* csg-ProximityIndicationParameters-r9 at 3781 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* neighCellSI-AcquisitionParameters-r9 at 3782 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* son-Parameters-r9 at 3783 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* nonCriticalExtension at 3784 */
};
