 ...
 */
static void
ue_ConfigRelease_r9_2_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
ue_ConfigRelease_r9_2_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	ue_ConfigRelease_r9_2_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
ue_ConfigRelease_r9_2_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
ue_ConfigRelease_r9_2_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
ue_ConfigRelease_r9_2_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
ue_ConfigRelease_r9_2_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
ue_ConfigRelease_r9_2_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
ue_ConfigRelease_r9_2_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
ue_ConfigRelease_r9_2_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
ue_ConfigRelease_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ue_ConfigRelease_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
ue_ConfigRelease_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ue_ConfigRelease_r9_2_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_ue_ConfigRelease_r9_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  3,  3,  0,  7 }	/* (0..7,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_ue_ConfigRelease_r9_value2enum_2[] = {
	{ 0,	4,	"rel9" },
	{ 1,	5,	"rel10" },
	{ 2,	6,	"spare6" },
	{ 3,	6,	"spare5" },
...
static ber_tlv_tag_t asn_DEF_ue_ConfigRelease_r9_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_ue_ConfigRelease_r9_2 = {
	"ue-ConfigRelease-r9",
	"ue-ConfigRelease-r9",
	ue_ConfigRelease_r9_2_free,
	ue_ConfigRelease_r9_2_print,
	ue_ConfigRelease_r9_2_constraint,
	ue_ConfigRelease_r9_2_decode_ber,
	ue_ConfigRelease_r9_2_encode_der,
	ue_ConfigRelease_r9_2_decode_xer,
	ue_ConfigRelease_r9_2_encode_xer,
	ue_ConfigRelease_r9_2_decode_uper,
	ue_ConfigRelease_r9_2_encode_uper,
	ue_ConfigRelease_r9_2_decode_aper,
	ue_ConfigRelease_r9_2_encode_aper,
	...
	&asn_PER_type_ue_ConfigRelease_r9_constr_2,
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_12 = {
	sizeof(struct HandoverPreparationInformation_v920_IEs__nonCriticalExtension),
	offsetof(struct HandoverPreparationInformation_v920_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_HandoverPreparationInformation_v920_IEs_1[] = {
...
static int asn_MAP_HandoverPreparationInformation_v920_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_HandoverPreparationInformation_v920_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_HandoverPreparationInformation_v920_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-ConfigRelease-r9 at 4232 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension at 4234 */
};
