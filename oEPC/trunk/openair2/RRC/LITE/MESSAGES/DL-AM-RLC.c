...
static asn_TYPE_member_t asn_MBR_DL_AM_RLC_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_AM_RLC, t_Reordering),
...
static ber_tlv_tag_t asn_DEF_DL_AM_RLC_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DL_AM_RLC_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* t-Reordering at 2547 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* t-StatusProhibit at 2549 */
};
static asn_SEQUENCE_specifics_t asn_SPC_DL_AM_RLC_specs_1 = {
