...
static asn_enc_rval_t
intraFreqProximityIndication_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	intraFreqProximityIndication_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
intraFreqProximityIndication_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	intraFreqProximityIndication_r9_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
interFreqProximityIndication_r9_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	interFreqProximityIndication_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
interFreqProximityIndication_r9_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	interFreqProximityIndication_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
utran_ProximityIndication_r9_6_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	utran_ProximityIndication_r9_6_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
utran_ProximityIndication_r9_6_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	utran_ProximityIndication_r9_6_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_intraFreqProximityIndication_r9_2 = {
	...
	intraFreqProximityIndication_r9_2_decode_aper,
	intraFreqProximityIndication_r9_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_interFreqProximityIndication_r9_4 = {
	...
	interFreqProximityIndication_r9_4_decode_aper,
	interFreqProximityIndication_r9_4_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
asn_TYPE_descriptor_t asn_DEF_utran_ProximityIndication_r9_6 = {
	...
	utran_ProximityIndication_r9_6_decode_aper,
	utran_ProximityIndication_r9_6_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_CSG_ProximityIndicationParameters_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqProximityIndication-r9 at 4023 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* interFreqProximityIndication-r9 at 4024 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* utran-ProximityIndication-r9 at 4025 */
};
