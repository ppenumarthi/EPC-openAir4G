...
asn_enc_rval_t
CQI_ReportModeAperiodic_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	CQI_ReportModeAperiodic_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
CQI_ReportModeAperiodic_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	CQI_ReportModeAperiodic_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_CQI_ReportModeAperiodic = {
	...
	CQI_ReportModeAperiodic_decode_aper,
	CQI_ReportModeAperiodic_encode_aper,
