...
static asn_enc_rval_t
transmissionModeUL_r10_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	transmissionModeUL_r10_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
transmissionModeUL_r10_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	transmissionModeUL_r10_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
fourAntennaPortActivated_r10_11_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	fourAntennaPortActivated_r10_11_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
fourAntennaPortActivated_r10_11_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	fourAntennaPortActivated_r10_11_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_transmissionModeUL_r10_2 = {
	...
	transmissionModeUL_r10_2_decode_aper,
	transmissionModeUL_r10_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_fourAntennaPortActivated_r10_11 = {
	...
	fourAntennaPortActivated_r10_11_decode_aper,
	fourAntennaPortActivated_r10_11_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_AntennaInfoUL_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transmissionModeUL-r10 at 1857 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* fourAntennaPortActivated-r10 at 1859 */
};
