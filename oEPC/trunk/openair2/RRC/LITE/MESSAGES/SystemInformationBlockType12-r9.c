...
static asn_enc_rval_t
warningMessageSegmentType_r9_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	warningMessageSegmentType_r9_4_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
warningMessageSegmentType_r9_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	warningMessageSegmentType_r9_4_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_warningMessageSegmentType_r9_4 = {
	...
	warningMessageSegmentType_r9_4_decode_aper,
	warningMessageSegmentType_r9_4_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType12_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* messageIdentifier-r9 at 1793 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* serialNumber-r9 at 1794 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* warningMessageSegmentType-r9 at 1795 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* warningMessageSegmentNumber-r9 at 1796 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* warningMessageSegment-r9 at 1797 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* dataCodingScheme-r9 at 1798 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* lateNonCriticalExtension at 1799 */
};
