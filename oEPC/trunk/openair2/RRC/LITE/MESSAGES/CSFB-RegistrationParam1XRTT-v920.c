...
static asn_enc_rval_t
powerDownReg_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	powerDownReg_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
powerDownReg_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	powerDownReg_r9_2_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_powerDownReg_r9_constr_2 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_powerDownReg_r9_2 = {
	...
	powerDownReg_r9_2_decode_aper,
	powerDownReg_r9_2_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_CSFB_RegistrationParam1XRTT_v920_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* powerDownReg-r9 at 2971 */
};
