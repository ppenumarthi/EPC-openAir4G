...
static asn_per_constraints_t asn_PER_memb_cellIdentity_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  28,  28 }	/* (SIZE(28..28)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_CellGlobalIdUTRA_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdUTRA, cellIdentity),
		...
		&asn_PER_memb_cellIdentity_constr_3,
		0,
		"cellIdentity"
		},
};
static ber_tlv_tag_t asn_DEF_CellGlobalIdUTRA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CellGlobalIdUTRA_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-Identity at 2982 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellIdentity at 2983 */
};
static asn_SEQUENCE_specifics_t asn_SPC_CellGlobalIdUTRA_specs_1 = {
