...
static int asn_MAP_RRCConnectionReestablishmentReject_r8_IEs_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_RRCConnectionReestablishmentReject_r8_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionReestablishmentReject_r8_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* nonCriticalExtension at 788 */
};
