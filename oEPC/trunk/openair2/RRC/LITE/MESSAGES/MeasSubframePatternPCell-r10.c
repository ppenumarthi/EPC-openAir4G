...
static asn_per_constraints_t asn_PER_type_MeasSubframePatternPCell_r10_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_tag2member_t asn_MAP_MeasSubframePatternPCell_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release at 2515 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup at 2517 */
};
