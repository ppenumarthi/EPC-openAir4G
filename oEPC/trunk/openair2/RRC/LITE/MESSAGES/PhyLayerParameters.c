...
static asn_TYPE_member_t asn_MBR_PhyLayerParameters_1[] = {
...
static ber_tlv_tag_t asn_DEF_PhyLayerParameters_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PhyLayerParameters_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-TxAntennaSelectionSupported at 3828 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ue-SpecificRefSigsSupported at 3829 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PhyLayerParameters_specs_1 = {
