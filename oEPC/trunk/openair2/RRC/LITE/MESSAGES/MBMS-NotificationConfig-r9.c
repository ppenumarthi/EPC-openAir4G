...
static asn_enc_rval_t
notificationRepetitionCoeff_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	notificationRepetitionCoeff_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
notificationRepetitionCoeff_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	notificationRepetitionCoeff_r9_2_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_notificationRepetitionCoeff_r9_2 = {
	...
	notificationRepetitionCoeff_r9_2_decode_aper,
	notificationRepetitionCoeff_r9_2_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_MBMS_NotificationConfig_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* notificationRepetitionCoeff-r9 at 4065 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* notificationOffset-r9 at 4066 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* notificationSF-Index-r9 at 4067 */
};
