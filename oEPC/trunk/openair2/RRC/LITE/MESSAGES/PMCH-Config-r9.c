...
static asn_enc_rval_t
mch_SchedulingPeriod_r9_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	mch_SchedulingPeriod_r9_4_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
mch_SchedulingPeriod_r9_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	mch_SchedulingPeriod_r9_4_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_r9_4 = {
	...
	mch_SchedulingPeriod_r9_4_decode_aper,
	mch_SchedulingPeriod_r9_4_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_PMCH_Config_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sf-AllocEnd-r9 at 4115 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dataMCS-r9 at 4116 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* mch-SchedulingPeriod-r9 at 4118 */
};
