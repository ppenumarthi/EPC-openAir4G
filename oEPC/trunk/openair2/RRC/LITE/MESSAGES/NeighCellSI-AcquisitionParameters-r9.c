...
static asn_enc_rval_t
intraFreqSI_AcquisitionForHO_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	intraFreqSI_AcquisitionForHO_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
intraFreqSI_AcquisitionForHO_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	intraFreqSI_AcquisitionForHO_r9_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
interFreqSI_AcquisitionForHO_r9_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	interFreqSI_AcquisitionForHO_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
interFreqSI_AcquisitionForHO_r9_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	interFreqSI_AcquisitionForHO_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
utran_SI_AcquisitionForHO_r9_6_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	utran_SI_AcquisitionForHO_r9_6_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
utran_SI_AcquisitionForHO_r9_6_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	utran_SI_AcquisitionForHO_r9_6_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_INTEGER_enum_map_t asn_MAP_intraFreqSI_AcquisitionForHO_r9_value2enum_2[] = {
	{ 0,	9,	"supported" }
};
static unsigned int asn_MAP_intraFreqSI_AcquisitionForHO_r9_enum2value_2[] = {
	0	/* supported(0) */
};
static asn_INTEGER_specifics_t asn_SPC_intraFreqSI_AcquisitionForHO_r9_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_intraFreqSI_AcquisitionForHO_r9_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_intraFreqSI_AcquisitionForHO_r9_2 = {
	...
	intraFreqSI_AcquisitionForHO_r9_2_decode_aper,
	intraFreqSI_AcquisitionForHO_r9_2_encode_aper,
...
static asn_INTEGER_enum_map_t asn_MAP_interFreqSI_AcquisitionForHO_r9_value2enum_4[] = {
	{ 0,	9,	"supported" }
};
static unsigned int asn_MAP_interFreqSI_AcquisitionForHO_r9_enum2value_4[] = {
	0	/* supported(0) */
};
static asn_INTEGER_specifics_t asn_SPC_interFreqSI_AcquisitionForHO_r9_specs_4 = {
...
static ber_tlv_tag_t asn_DEF_interFreqSI_AcquisitionForHO_r9_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_interFreqSI_AcquisitionForHO_r9_4 = {
	...
	interFreqSI_AcquisitionForHO_r9_4_decode_aper,
	interFreqSI_AcquisitionForHO_r9_4_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_INTEGER_enum_map_t asn_MAP_utran_SI_AcquisitionForHO_r9_value2enum_6[] = {
	{ 0,	9,	"supported" }
};
static unsigned int asn_MAP_utran_SI_AcquisitionForHO_r9_enum2value_6[] = {
	0	/* supported(0) */
};
static asn_INTEGER_specifics_t asn_SPC_utran_SI_AcquisitionForHO_r9_specs_6 = {
...
static ber_tlv_tag_t asn_DEF_utran_SI_AcquisitionForHO_r9_tags_6[] = {
...
asn_TYPE_descriptor_t asn_DEF_utran_SI_AcquisitionForHO_r9_6 = {
	...
	utran_SI_AcquisitionForHO_r9_6_decode_aper,
	utran_SI_AcquisitionForHO_r9_6_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static int asn_MAP_NeighCellSI_AcquisitionParameters_r9_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_NeighCellSI_AcquisitionParameters_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_NeighCellSI_AcquisitionParameters_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqSI-AcquisitionForHO-r9 at 4029 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* interFreqSI-AcquisitionForHO-r9 at 4030 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* utran-SI-AcquisitionForHO-r9 at 4031 */
};
