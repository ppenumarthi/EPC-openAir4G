...
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensionsFuture_specs_4 = {
	...
	offsetof(struct CSFBParametersRequestCDMA2000__criticalExtensions__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSFBParametersRequestCDMA2000__criticalExtensions, choice.csfbParametersRequestCDMA2000_r8),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSFBParametersRequestCDMA2000__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_criticalExtensions_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* csfbParametersRequestCDMA2000-r8 at 194 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensionsFuture at 195 */
};
static asn_CHOICE_specifics_t asn_SPC_criticalExtensions_specs_2 = {
	...
	offsetof(struct CSFBParametersRequestCDMA2000__criticalExtensions, _asn_ctx),
	offsetof(struct CSFBParametersRequestCDMA2000__criticalExtensions, present),
	sizeof(((struct CSFBParametersRequestCDMA2000__criticalExtensions *)0)->present),
...
static asn_TYPE_member_t asn_MBR_CSFBParametersRequestCDMA2000_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSFBParametersRequestCDMA2000, criticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static ber_tlv_tag_t asn_DEF_CSFBParametersRequestCDMA2000_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CSFBParametersRequestCDMA2000_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* criticalExtensions at 194 */
};
static asn_SEQUENCE_specifics_t asn_SPC_CSFBParametersRequestCDMA2000_specs_1 = {
	sizeof(struct CSFBParametersRequestCDMA2000),
	offsetof(struct CSFBParametersRequestCDMA2000, _asn_ctx),
	asn_MAP_CSFBParametersRequestCDMA2000_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_CSFBParametersRequestCDMA2000 = {
	...
	SEQUENCE_encode_aper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_CSFBParametersRequestCDMA2000_tags_1,
	sizeof(asn_DEF_CSFBParametersRequestCDMA2000_tags_1)
		/sizeof(asn_DEF_CSFBParametersRequestCDMA2000_tags_1[0]), /* 1 */
	asn_DEF_CSFBParametersRequestCDMA2000_tags_1,	/* Same as above */
	sizeof(asn_DEF_CSFBParametersRequestCDMA2000_tags_1)
		/sizeof(asn_DEF_CSFBParametersRequestCDMA2000_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_CSFBParametersRequestCDMA2000_1,
	1,	/* Elements count */
	&asn_SPC_CSFBParametersRequestCDMA2000_specs_1	/* Additional specs */
};
