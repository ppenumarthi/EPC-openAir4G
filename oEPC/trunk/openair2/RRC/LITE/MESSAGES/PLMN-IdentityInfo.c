...
static asn_enc_rval_t
cellReservedForOperatorUse_3_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	cellReservedForOperatorUse_3_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
cellReservedForOperatorUse_3_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	cellReservedForOperatorUse_3_inherit_TYPE_descriptor(td);
...
static unsigned int asn_MAP_cellReservedForOperatorUse_enum2value_3[] = {
	1,	/* notReserved(1) */
	0	/* reserved(0) */
};
static asn_INTEGER_specifics_t asn_SPC_cellReservedForOperatorUse_specs_3 = {
...
static ber_tlv_tag_t asn_DEF_cellReservedForOperatorUse_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_cellReservedForOperatorUse_3 = {
	...
	cellReservedForOperatorUse_3_decode_aper,
	cellReservedForOperatorUse_3_encode_aper,
...
static ber_tlv_tag_t asn_DEF_PLMN_IdentityInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PLMN_IdentityInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-Identity at 1207 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellReservedForOperatorUse at 1208 */
};
