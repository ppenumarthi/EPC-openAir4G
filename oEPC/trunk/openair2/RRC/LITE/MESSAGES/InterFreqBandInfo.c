...
static asn_TYPE_member_t asn_MBR_InterFreqBandInfo_1[] = {
...
static ber_tlv_tag_t asn_DEF_InterFreqBandInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqBandInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* interFreqNeedForGaps at 3918 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqBandInfo_specs_1 = {
