...
static asn_per_constraints_t asn_PER_type_SupportedBandListUTRA_FDD_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_SupportedBandListUTRA_FDD_1[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_SupportedBandListUTRA_FDD_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_SupportedBandListUTRA_FDD_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SupportedBandListUTRA_FDD = {
	...
	sizeof(asn_DEF_SupportedBandListUTRA_FDD_tags_1)
		/sizeof(asn_DEF_SupportedBandListUTRA_FDD_tags_1[0]), /* 1 */
	&asn_PER_type_SupportedBandListUTRA_FDD_constr_1,
