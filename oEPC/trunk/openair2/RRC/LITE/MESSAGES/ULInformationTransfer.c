...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ULInformationTransfer__criticalExtensions__c1, choice.ulInformationTransfer_r8),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ULInformationTransfer__criticalExtensions__c1, choice.spare3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ULInformationTransfer__criticalExtensions__c1, choice.spare2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ULInformationTransfer__criticalExtensions__c1, choice.spare1),
...
static asn_TYPE_tag2member_t asn_MAP_c1_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ulInformationTransfer-r8 at 1445 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* spare3 at 1446 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* spare2 at 1446 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* spare1 at 1446 */
};
static asn_CHOICE_specifics_t asn_SPC_c1_specs_3 = {
	sizeof(struct ULInformationTransfer__criticalExtensions__c1),
	offsetof(struct ULInformationTransfer__criticalExtensions__c1, _asn_ctx),
	offsetof(struct ULInformationTransfer__criticalExtensions__c1, present),
	sizeof(((struct ULInformationTransfer__criticalExtensions__c1 *)0)->present),
	asn_MAP_c1_tag2el_3,
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ULInformationTransfer__criticalExtensions, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ULInformationTransfer__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_criticalExtensions_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* c1 at 1445 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensionsFuture at 1448 */
};
...
static asn_TYPE_member_t asn_MBR_ULInformationTransfer_1[] = {
...
static ber_tlv_tag_t asn_DEF_ULInformationTransfer_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ULInformationTransfer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* criticalExtensions at 1447 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ULInformationTransfer_specs_1 = {
