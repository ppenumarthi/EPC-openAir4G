...
static asn_per_constraints_t asn_PER_memb_bandEUTRA_r10_constr_2 GCC_NOTUSED = {
...
static asn_TYPE_tag2member_t asn_MAP_BandParameters_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* bandEUTRA-r10 at 3866 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* bandParametersUL-r10 at 3867 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* bandParametersDL-r10 at 3868 */
};
