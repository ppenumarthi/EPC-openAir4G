...
static int
si_RequestForHO_r9_36_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
si_RequestForHO_r9_36_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
	td->der_encoder    = asn_DEF_NativeEnumerated.der_encoder;
...
static void
si_RequestForHO_r9_36_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
si_RequestForHO_r9_36_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
si_RequestForHO_r9_36_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
si_RequestForHO_r9_36_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
si_RequestForHO_r9_36_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
si_RequestForHO_r9_36_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
si_RequestForHO_r9_36_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
si_RequestForHO_r9_36_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_enc_rval_t
si_RequestForHO_r9_36_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
si_RequestForHO_r9_36_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	si_RequestForHO_r9_36_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static int
reportQuantityUTRA_FDD_r10_38_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
	td->der_encoder    = asn_DEF_NativeEnumerated.der_encoder;
...
static void
reportQuantityUTRA_FDD_r10_38_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
reportQuantityUTRA_FDD_r10_38_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
reportQuantityUTRA_FDD_r10_38_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
reportQuantityUTRA_FDD_r10_38_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
reportQuantityUTRA_FDD_r10_38_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
reportQuantityUTRA_FDD_r10_38_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
reportQuantityUTRA_FDD_r10_38_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
reportQuantityUTRA_FDD_r10_38_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_enc_rval_t
reportQuantityUTRA_FDD_r10_38_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
reportQuantityUTRA_FDD_r10_38_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	reportQuantityUTRA_FDD_r10_38_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_per_constraints_t asn_PER_type_si_RequestForHO_r9_constr_36 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_reportQuantityUTRA_FDD_r10_constr_38 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_tag2member_t asn_MAP_b1_Threshold_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* b1-ThresholdUTRA at 3584 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* b1-ThresholdGERAN at 3585 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* b1-ThresholdCDMA2000 at 3587 */
};
...
static asn_TYPE_tag2member_t asn_MAP_eventB1_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* b1-Threshold at 3584 */
};
...
static asn_TYPE_tag2member_t asn_MAP_b2_Threshold2_tag2el_12[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* b2-Threshold2UTRA at 3592 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* b2-Threshold2GERAN at 3593 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* b2-Threshold2CDMA2000 at 3595 */
};
...
static asn_TYPE_tag2member_t asn_MAP_eventB2_tag2el_10[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* b2-Threshold1 at 3590 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* b2-Threshold2 at 3592 */
};
...
static asn_TYPE_tag2member_t asn_MAP_eventId_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eventB1 at 3588 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* eventB2 at 3590 */
};
...
static asn_TYPE_tag2member_t asn_MAP_event_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eventId at 3588 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* hysteresis at 3599 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* timeToTrigger at 3601 */
};
...
static asn_TYPE_tag2member_t asn_MAP_periodical_tag2el_19[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* purpose at 3604 */
};
...
static asn_TYPE_tag2member_t asn_MAP_triggerType_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* event at 3598 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* periodical at 3607 */
};
...
static asn_INTEGER_enum_map_t asn_MAP_si_RequestForHO_r9_value2enum_36[] = {
	{ 0,	5,	"setup" }
};
static unsigned int asn_MAP_si_RequestForHO_r9_enum2value_36[] = {
	0	/* setup(0) */
};
static asn_INTEGER_specifics_t asn_SPC_si_RequestForHO_r9_specs_36 = {
	asn_MAP_si_RequestForHO_r9_value2enum_36,	/* "tag" => N; sorted by tag */
	asn_MAP_si_RequestForHO_r9_enum2value_36,	/* N => "tag"; sorted by N */
...
static ber_tlv_tag_t asn_DEF_si_RequestForHO_r9_tags_36[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_si_RequestForHO_r9_36 = {
	"si-RequestForHO-r9",
	"si-RequestForHO-r9",
	si_RequestForHO_r9_36_free,
	si_RequestForHO_r9_36_print,
	si_RequestForHO_r9_36_constraint,
	si_RequestForHO_r9_36_decode_ber,
	si_RequestForHO_r9_36_encode_der,
	si_RequestForHO_r9_36_decode_xer,
	si_RequestForHO_r9_36_encode_xer,
	si_RequestForHO_r9_36_decode_uper,
	si_RequestForHO_r9_36_encode_uper,
	si_RequestForHO_r9_36_decode_aper,
	si_RequestForHO_r9_36_encode_aper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_si_RequestForHO_r9_tags_36,
	sizeof(asn_DEF_si_RequestForHO_r9_tags_36)
		/sizeof(asn_DEF_si_RequestForHO_r9_tags_36[0]) - 1, /* 1 */
	asn_DEF_si_RequestForHO_r9_tags_36,	/* Same as above */
	sizeof(asn_DEF_si_RequestForHO_r9_tags_36)
		/sizeof(asn_DEF_si_RequestForHO_r9_tags_36[0]), /* 2 */
	&asn_PER_type_si_RequestForHO_r9_constr_36,
	0, 0,	/* Defined elsewhere */
	&asn_SPC_si_RequestForHO_r9_specs_36	/* Additional specs */
};

static asn_INTEGER_enum_map_t asn_MAP_reportQuantityUTRA_FDD_r10_value2enum_38[] = {
	{ 0,	4,	"both" }
};
static unsigned int asn_MAP_reportQuantityUTRA_FDD_r10_enum2value_38[] = {
	0	/* both(0) */
};
static asn_INTEGER_specifics_t asn_SPC_reportQuantityUTRA_FDD_r10_specs_38 = {
	asn_MAP_reportQuantityUTRA_FDD_r10_value2enum_38,	/* "tag" => N; sorted by tag */
	asn_MAP_reportQuantityUTRA_FDD_r10_enum2value_38,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static ber_tlv_tag_t asn_DEF_reportQuantityUTRA_FDD_r10_tags_38[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_reportQuantityUTRA_FDD_r10_38 = {
	"reportQuantityUTRA-FDD-r10",
	"reportQuantityUTRA-FDD-r10",
	reportQuantityUTRA_FDD_r10_38_free,
	reportQuantityUTRA_FDD_r10_38_print,
	reportQuantityUTRA_FDD_r10_38_constraint,
	reportQuantityUTRA_FDD_r10_38_decode_ber,
	reportQuantityUTRA_FDD_r10_38_encode_der,
	reportQuantityUTRA_FDD_r10_38_decode_xer,
	reportQuantityUTRA_FDD_r10_38_encode_xer,
	reportQuantityUTRA_FDD_r10_38_decode_uper,
	reportQuantityUTRA_FDD_r10_38_encode_uper,
	reportQuantityUTRA_FDD_r10_38_decode_aper,
	reportQuantityUTRA_FDD_r10_38_encode_aper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_reportQuantityUTRA_FDD_r10_tags_38,
	sizeof(asn_DEF_reportQuantityUTRA_FDD_r10_tags_38)
		/sizeof(asn_DEF_reportQuantityUTRA_FDD_r10_tags_38[0]) - 1, /* 1 */
	asn_DEF_reportQuantityUTRA_FDD_r10_tags_38,	/* Same as above */
	sizeof(asn_DEF_reportQuantityUTRA_FDD_r10_tags_38)
		/sizeof(asn_DEF_reportQuantityUTRA_FDD_r10_tags_38[0]), /* 2 */
	&asn_PER_type_reportQuantityUTRA_FDD_r10_constr_38,
	0, 0,	/* Defined elsewhere */
	&asn_SPC_reportQuantityUTRA_FDD_r10_specs_38	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_ReportConfigInterRAT_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ReportConfigInterRAT, reportQuantityUTRA_FDD_r10),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_reportQuantityUTRA_FDD_r10_38,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"reportQuantityUTRA-FDD-r10"
...
static asn_TYPE_tag2member_t asn_MAP_ReportConfigInterRAT_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* triggerType at 3601 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* maxReportCells at 3609 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* reportInterval at 3610 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* reportAmount at 3611 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* si-RequestForHO-r9 at 3613 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* reportQuantityUTRA-FDD-r10 at 3615 */
};
