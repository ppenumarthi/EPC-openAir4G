...
static asn_enc_rval_t
semiPersistSchedIntervalUL_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	semiPersistSchedIntervalUL_4_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
semiPersistSchedIntervalUL_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	semiPersistSchedIntervalUL_4_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
implicitReleaseAfter_21_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	implicitReleaseAfter_21_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
implicitReleaseAfter_21_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	implicitReleaseAfter_21_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
twoIntervalsConfig_29_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	twoIntervalsConfig_29_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
twoIntervalsConfig_29_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	twoIntervalsConfig_29_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_semiPersistSchedIntervalUL_4 = {
	...
	semiPersistSchedIntervalUL_4_decode_aper,
	semiPersistSchedIntervalUL_4_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_implicitReleaseAfter_21 = {
	...
	implicitReleaseAfter_21_decode_aper,
	implicitReleaseAfter_21_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_p0_Persistent_tag2el_26[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* p0-NominalPUSCH-Persistent at 2772 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* p0-UE-PUSCH-Persistent at 2773 */
};
...
asn_TYPE_descriptor_t asn_DEF_twoIntervalsConfig_29 = {
	...
	twoIntervalsConfig_29_decode_aper,
	twoIntervalsConfig_29_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_setup_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* semiPersistSchedIntervalUL at 2766 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* implicitReleaseAfter at 2770 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* p0-Persistent at 2772 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* twoIntervalsConfig at 2775 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SPS_ConfigUL_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release at 2763 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup at 2769 */
};
