...
asn_enc_rval_t
ShortMAC_I_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ShortMAC_I_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
ShortMAC_I_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ShortMAC_I_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_ShortMAC_I = {
	...
	ShortMAC_I_decode_aper,
	ShortMAC_I_encode_aper,
