...
static asn_enc_rval_t
proximityIndicationEUTRA_r9_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	proximityIndicationEUTRA_r9_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
proximityIndicationEUTRA_r9_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	proximityIndicationEUTRA_r9_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
proximityIndicationUTRA_r9_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	proximityIndicationUTRA_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
proximityIndicationUTRA_r9_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	proximityIndicationUTRA_r9_4_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_INTEGER_enum_map_t asn_MAP_proximityIndicationEUTRA_r9_value2enum_2[] = {
	{ 0,	7,	"enabled" }
};
static unsigned int asn_MAP_proximityIndicationEUTRA_r9_enum2value_2[] = {
	0	/* enabled(0) */
};
static asn_INTEGER_specifics_t asn_SPC_proximityIndicationEUTRA_r9_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_proximityIndicationEUTRA_r9_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_proximityIndicationEUTRA_r9_2 = {
	...
	proximityIndicationEUTRA_r9_2_decode_aper,
	proximityIndicationEUTRA_r9_2_encode_aper,
...
static asn_INTEGER_enum_map_t asn_MAP_proximityIndicationUTRA_r9_value2enum_4[] = {
	{ 0,	7,	"enabled" }
};
static unsigned int asn_MAP_proximityIndicationUTRA_r9_enum2value_4[] = {
	0	/* enabled(0) */
};
static asn_INTEGER_specifics_t asn_SPC_proximityIndicationUTRA_r9_specs_4 = {
...
static ber_tlv_tag_t asn_DEF_proximityIndicationUTRA_r9_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_proximityIndicationUTRA_r9_4 = {
	...
	proximityIndicationUTRA_r9_4_decode_aper,
	proximityIndicationUTRA_r9_4_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static int asn_MAP_ReportProximityConfig_r9_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_ReportProximityConfig_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ReportProximityConfig_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* proximityIndicationEUTRA-r9 at 3719 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* proximityIndicationUTRA-r9 at 3720 */
};
