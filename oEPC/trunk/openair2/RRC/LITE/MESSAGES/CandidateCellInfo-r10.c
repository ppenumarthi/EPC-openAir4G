...
static asn_TYPE_member_t asn_MBR_CandidateCellInfo_r10_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct CandidateCellInfo_r10, rsrpResult_r10),
	...
	{ ATF_POINTER, 1, offsetof(struct CandidateCellInfo_r10, rsrqResult_r10),
...
static int asn_MAP_CandidateCellInfo_r10_oms_1[] = { 2, 3 };
...
static asn_TYPE_tag2member_t asn_MAP_CandidateCellInfo_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* physCellId-r10 at 4321 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dl-CarrierFreq-r10 at 4322 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* rsrpResult-r10 at 4324 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* rsrqResult-r10 at 4325 */
};
