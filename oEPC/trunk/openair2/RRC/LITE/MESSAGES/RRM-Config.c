...
static asn_TYPE_member_t asn_MBR_RRM_Config_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RRM_Config, candidateCellInfoList_r10),
...
static int asn_MAP_RRM_Config_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_RRM_Config_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRM_Config_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-InactiveTime at 4303 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* candidateCellInfoList-r10 at 4313 */
};
