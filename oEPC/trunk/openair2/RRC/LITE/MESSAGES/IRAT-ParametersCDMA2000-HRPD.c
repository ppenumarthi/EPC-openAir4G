...
static asn_enc_rval_t
tx_ConfigHRPD_3_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	tx_ConfigHRPD_3_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
tx_ConfigHRPD_3_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	tx_ConfigHRPD_3_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
rx_ConfigHRPD_6_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	rx_ConfigHRPD_6_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
rx_ConfigHRPD_6_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	rx_ConfigHRPD_6_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_tx_ConfigHRPD_3 = {
	...
	tx_ConfigHRPD_3_decode_aper,
	tx_ConfigHRPD_3_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_rx_ConfigHRPD_6 = {
	...
	rx_ConfigHRPD_6_decode_aper,
	rx_ConfigHRPD_6_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_IRAT_ParametersCDMA2000_HRPD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportedBandListHRPD at 3998 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tx-ConfigHRPD at 3999 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* rx-ConfigHRPD at 4000 */
};
