...
static asn_per_constraints_t asn_PER_type_ThresholdEUTRA_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ThresholdEUTRA_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_ThresholdEUTRA_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* threshold-RSRP at 3570 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* threshold-RSRQ at 3572 */
};
...
asn_TYPE_descriptor_t asn_DEF_ThresholdEUTRA = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_ThresholdEUTRA_constr_1,
