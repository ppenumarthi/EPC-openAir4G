...
static int
logicalChannelSR_Mask_r9_32_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
	td->der_encoder    = asn_DEF_NativeEnumerated.der_encoder;
...
static void
logicalChannelSR_Mask_r9_32_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
logicalChannelSR_Mask_r9_32_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
logicalChannelSR_Mask_r9_32_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
logicalChannelSR_Mask_r9_32_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
logicalChannelSR_Mask_r9_32_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
logicalChannelSR_Mask_r9_32_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
logicalChannelSR_Mask_r9_32_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
logicalChannelSR_Mask_r9_32_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_enc_rval_t
logicalChannelSR_Mask_r9_32_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
logicalChannelSR_Mask_r9_32_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	logicalChannelSR_Mask_r9_32_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_per_constraints_t asn_PER_type_logicalChannelSR_Mask_r9_constr_32 GCC_NOTUSED = {
...
static asn_TYPE_tag2member_t asn_MAP_ul_SpecificParameters_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* priority at 1997 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* prioritisedBitRate at 1999 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* bucketSizeDuration at 2004 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* logicalChannelGroup at 2006 */
};
...
static asn_INTEGER_enum_map_t asn_MAP_logicalChannelSR_Mask_r9_value2enum_32[] = {
	{ 0,	5,	"setup" }
};
static unsigned int asn_MAP_logicalChannelSR_Mask_r9_enum2value_32[] = {
	0	/* setup(0) */
};
static asn_INTEGER_specifics_t asn_SPC_logicalChannelSR_Mask_r9_specs_32 = {
...
static ber_tlv_tag_t asn_DEF_logicalChannelSR_Mask_r9_tags_32[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_logicalChannelSR_Mask_r9_32 = {
	...
	"logicalChannelSR-Mask-r9",
	logicalChannelSR_Mask_r9_32_free,
	logicalChannelSR_Mask_r9_32_print,
	logicalChannelSR_Mask_r9_32_constraint,
	logicalChannelSR_Mask_r9_32_decode_ber,
	logicalChannelSR_Mask_r9_32_encode_der,
	logicalChannelSR_Mask_r9_32_decode_xer,
	logicalChannelSR_Mask_r9_32_encode_xer,
	logicalChannelSR_Mask_r9_32_decode_uper,
	logicalChannelSR_Mask_r9_32_encode_uper,
	logicalChannelSR_Mask_r9_32_decode_aper,
	logicalChannelSR_Mask_r9_32_encode_aper,
	0,	/* Use generic outmost tag fetcher */
	...
	&asn_PER_type_logicalChannelSR_Mask_r9_constr_32,
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_tag2member_t asn_MAP_LogicalChannelConfig_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-SpecificParameters at 1997 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* logicalChannelSR-Mask-r9 at 2009 */
};
