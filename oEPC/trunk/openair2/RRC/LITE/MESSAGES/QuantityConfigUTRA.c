...
static asn_enc_rval_t
measQuantityUTRA_FDD_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	measQuantityUTRA_FDD_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
measQuantityUTRA_FDD_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	measQuantityUTRA_FDD_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
measQuantityUTRA_TDD_5_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	measQuantityUTRA_TDD_5_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
measQuantityUTRA_TDD_5_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	measQuantityUTRA_TDD_5_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_measQuantityUTRA_FDD_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_measQuantityUTRA_TDD_constr_5 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_measQuantityUTRA_FDD_2 = {
	...
	measQuantityUTRA_FDD_2_decode_aper,
	measQuantityUTRA_FDD_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_measQuantityUTRA_TDD_5 = {
	...
	measQuantityUTRA_TDD_5_decode_aper,
	measQuantityUTRA_TDD_5_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_QuantityConfigUTRA_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measQuantityUTRA-FDD at 3501 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* measQuantityUTRA-TDD at 3502 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* filterCoefficient at 3503 */
};
