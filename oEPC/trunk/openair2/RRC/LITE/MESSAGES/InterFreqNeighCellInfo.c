...
static asn_TYPE_member_t asn_MBR_InterFreqNeighCellInfo_1[] = {
...
static ber_tlv_tag_t asn_DEF_InterFreqNeighCellInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqNeighCellInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* physCellId at 1603 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* q-OffsetCell at 1605 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqNeighCellInfo_specs_1 = {
