...
static asn_per_constraints_t asn_PER_type_UE_CapabilityRAT_ContainerList_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  0,  8 }	/* (SIZE(0..8)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_UE_CapabilityRAT_ContainerList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_UE_CapabilityRAT_ContainerList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_UE_CapabilityRAT_ContainerList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_UE_CapabilityRAT_ContainerList = {
	...
	sizeof(asn_DEF_UE_CapabilityRAT_ContainerList_tags_1)
		/sizeof(asn_DEF_UE_CapabilityRAT_ContainerList_tags_1[0]), /* 1 */
	&asn_PER_type_UE_CapabilityRAT_ContainerList_constr_1,
