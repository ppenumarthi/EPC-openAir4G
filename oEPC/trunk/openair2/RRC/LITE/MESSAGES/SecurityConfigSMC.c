...
static asn_TYPE_member_t asn_MBR_SecurityConfigSMC_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_SecurityConfigSMC_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* securityAlgorithmConfig at 1096 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SecurityConfigSMC_specs_1 = {
