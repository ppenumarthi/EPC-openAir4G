...
static asn_enc_rval_t
pmi_RI_Report_r10_5_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	pmi_RI_Report_r10_5_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
pmi_RI_Report_r10_5_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	pmi_RI_Report_r10_5_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_pmi_RI_Report_r10_5 = {
	...
	pmi_RI_Report_r10_5_decode_aper,
	pmi_RI_Report_r10_5_encode_aper,
...
static asn_TYPE_tag2member_t asn_MAP_CQI_ReportConfigSCell_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cqi-ReportModeAperiodic-r10 at 1889 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* nomPDSCH-RS-EPRE-Offset-r10 at 1890 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* cqi-ReportPeriodicSCell-r10 at 1892 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* pmi-RI-Report-r10 at 1893 */
};
