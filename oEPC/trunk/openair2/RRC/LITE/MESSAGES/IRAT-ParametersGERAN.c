...
static asn_TYPE_member_t asn_MBR_IRAT_ParametersGERAN_1[] = {
...
static ber_tlv_tag_t asn_DEF_IRAT_ParametersGERAN_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_IRAT_ParametersGERAN_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportedBandListGERAN at 3981 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* interRAT-PS-HO-ToGERAN at 3982 */
};
static asn_SEQUENCE_specifics_t asn_SPC_IRAT_ParametersGERAN_specs_1 = {
