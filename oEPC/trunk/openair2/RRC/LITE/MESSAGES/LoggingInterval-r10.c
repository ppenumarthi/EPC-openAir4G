...
asn_enc_rval_t
LoggingInterval_r10_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	LoggingInterval_r10_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
LoggingInterval_r10_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	LoggingInterval_r10_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_LoggingInterval_r10 = {
	...
	LoggingInterval_r10_decode_aper,
	LoggingInterval_r10_encode_aper,
