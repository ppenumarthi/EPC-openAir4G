...
asn_enc_rval_t
TimeAlignmentTimer_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TimeAlignmentTimer_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TimeAlignmentTimer_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TimeAlignmentTimer_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_TimeAlignmentTimer_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_TimeAlignmentTimer = {
	...
	TimeAlignmentTimer_decode_aper,
	TimeAlignmentTimer_encode_aper,
