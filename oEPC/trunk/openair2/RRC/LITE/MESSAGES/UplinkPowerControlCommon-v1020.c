...
static asn_enc_rval_t
deltaF_PUCCH_Format3_r10_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	deltaF_PUCCH_Format3_r10_2_inherit_TYPE_descriptor(td);
...
static asn_dec_rval_t
deltaF_PUCCH_Format3_r10_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	deltaF_PUCCH_Format3_r10_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
deltaF_PUCCH_Format1bCS_r10_11_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	deltaF_PUCCH_Format1bCS_r10_11_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_dec_rval_t
deltaF_PUCCH_Format1bCS_r10_11_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	deltaF_PUCCH_Format1bCS_r10_11_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_deltaF_PUCCH_Format3_r10_2 = {
	...
	deltaF_PUCCH_Format3_r10_2_decode_aper,
	deltaF_PUCCH_Format3_r10_2_encode_aper,
...
asn_TYPE_descriptor_t asn_DEF_deltaF_PUCCH_Format1bCS_r10_11 = {
	...
	deltaF_PUCCH_Format1bCS_r10_11_decode_aper,
	deltaF_PUCCH_Format1bCS_r10_11_encode_aper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_UplinkPowerControlCommon_v1020_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* deltaF-PUCCH-Format3-r10 at 2819 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* deltaF-PUCCH-Format1bCS-r10 at 2821 */
};
