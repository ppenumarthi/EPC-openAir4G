...
main (int argc, char **argv) {
    ...
    LOG_N(EMU,"################ PRINTING CONSTANT VALUES STARTS ################\n");

    LOG_N(EMU,"GTPV1U_ENB_TUNNEL_DATA_REQ:: %d\n",GTPV1U_ENB_TUNNEL_DATA_REQ);
    //LOG_N(EMU,"GTPV1U_TUNNEL_DATA_REQ: %d\n",GTPV1U_TUNNEL_DATA_REQ);
    LOG_N(EMU,"UDP_DATA_IND: %d\n",UDP_DATA_IND);
    LOG_N(EMU,"MESSAGES_ID_MAX: %d\n",MESSAGES_ID_MAX);
    LOG_N(EMU,"UDP_DATA_REQ: %d\n",UDP_DATA_REQ);
    LOG_N(EMU,"UDP_DATA_IND: %d\n",UDP_DATA_IND);
    LOG_N(EMU,"TASK_GTPV1_U: %d\n",TASK_GTPV1_U);
    //LOG_N(EMU,"TASK_FW_IP,: %d\n",TASK_FW_IP,);
    LOG_N(EMU,"TASK_ENB_APP,: %d\n",TASK_ENB_APP);
    LOG_N(EMU,"TASK_TRAFFIC_SGI: %d\n",TASK_TRAFFIC_SGI);
    LOG_N(EMU,"TASK_MAX: %d\n",TASK_MAX);
    //LOG_N(EMU,"TASK_SPGW_APP: %d\n",TASK_SPGW_APP);
    LOG_N(EMU,"TASK_UDP: %d\n",TASK_UDP);
    LOG_N(EMU,"ACTIVATE_MESSAGE:: %d\n",ACTIVATE_MESSAGE);
    LOG_N(EMU,"DEACTIVATE_MESSAGE: %d\n",DEACTIVATE_MESSAGE);
    LOG_N(EMU,"TERMINATE_MESSAGE: %d\n",TERMINATE_MESSAGE);
    //LOG_N(EMU,"SGI_CREATE_ENDPOINT_REQUEST:: %d\n",SGI_CREATE_ENDPOINT_REQUEST);
    //LOG_N(EMU,"SGI_UPDATE_ENDPOINT_REQUEST:: %d\n",SGI_UPDATE_ENDPOINT_REQUEST);

    LOG_N(EMU,"################ PRINTING CONSTANT VALUES ENDS ################\n");
