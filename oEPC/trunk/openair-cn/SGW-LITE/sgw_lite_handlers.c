...
double t1=tim.tv_sec+(tim.tv_usec/1000000.0);              
  SPGW_APP_DEBUG("SEND %.6lf %s %d\n", t1, "GTPV1U_CREATE_TUNNEL_REQ", sizeof(*message_p));

/*SPGW_APP_DEBUG("-------------------------------\n" );
  SPGW_APP_DEBUG("Current local time and date: %.6lf \n", t1 );
  SPGW_APP_DEBUG("Sending message: gtpv1uCreateTunnelReq \n"); */
  //SPGW_APP_DEBUG("SEND %.6lf %s %d\n", t1, "GTPV1U_CREATE_TUNNEL_REQ", sizeof(*message_p));
//  SPGW_APP_DEBUG("-------------------------------\n");
/*
...
double t1=tim.tv_sec+(tim.tv_usec/1000000.0);
    ...
    SPGW_APP_DEBUG("SEND %.6lf CREATE-SESSION-RESPONSE MME %d\n",t1, sizeof(*message_p));
...
double t2=tim1.tv_sec+(tim1.tv_usec/1000000.0);     

  SPGW_APP_DEBUG("%.6lf GTPV1U_CREATE_TUNNEL_RESP %d\n", t2, sizeof( *endpoint_created_pP) );
//  /*
//   *  * Done with statistics
//    *   */
//
...
/*SPGW_APP_DEBUG("-------------------------------\n" );
  SPGW_APP_DEBUG("Current local time and date: %.6lf \n", t1 );
  SPGW_APP_DEBUG("Sending SGI_CREATE_ENDPOINT_REQUEST to TASK_FW_IP   \n", ITTI_MSG_ID(received_message_p), sizeof( *received_message_p) ); */
  SPGW_APP_DEBUG("SEND %.6lf SGI_CREATE_ENDPOINT_REQUEST %d\n", t1, sizeof( *received_message_p) );
//  SPGW_APP_DEBUG("-------------------------------\n");
/*
 *  * Done with statistics
 *   */
...
/*SPGW_APP_DEBUG("-------------------------------\n" );
  SPGW_APP_DEBUG("Current local time and date: %.6lf \n", t1 );
  SPGW_APP_DEBUG("Sending SgwCreateSessionResponse to TASK_MME\n" ); */
  SPGW_APP_DEBUG("SEND %.6lf SGW_CREATE_SESSION_RESPONSE %d\n", t1, sizeof(*message_p) );
//  SPGW_APP_DEBUG("-------------------------------i\n");
/*
 *  * Done with statistics
 *   */
