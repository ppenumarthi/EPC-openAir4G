 ...
 * Only for statistics */	
	...
	MME_APP_DEBUG("ITTI_MSG_ID(received_message_p) ::: %d and size is ::: %d \n", ITTI_MSG_ID(received_message_p), sizeof(*received_message_p) );
	MME_APP_DEBUG("SGW_CREATE_SESSION_RESPONSE: %d, MME_APP_INITIAL_CONTEXT_SETUP_RSP: %d, MME_APP_CONNECTION_ESTABLISHMENT_IND: %d \n", SGW_CREATE_SESSION_RESPONSE, MME_APP_INITIAL_CONTEXT_SETUP_RSP, MME_APP_CONNECTION_ESTABLISHMENT_IND); */
	if(ITTI_MSG_ID(received_message_p) == 11)
	MME_APP_DEBUG("ABCD %.6lf %s %d\n", t1, "TIMER_HAS_EXPIRED", sizeof(*received_message_p) );
	if(ITTI_MSG_ID(received_message_p) == 77)
	MME_APP_DEBUG("ABCD %.6lf %s %d\n", t1, "SGW_CREATE_SESSION_RESPONSE", sizeof(*received_message_p) );
	if(ITTI_MSG_ID(received_message_p) == 87)
	MME_APP_DEBUG("ABCD %.6lf %s %d\n", t1, "MME_APP_INITIAL_CONTEXT_SETUP_RSP", sizeof(*received_message_p) );
	if(ITTI_MSG_ID(received_message_p) == 85)
	MME_APP_DEBUG("ABCD %.6lf %s %d\n", t1, " MME_APP_CONNECTION_ESTABLISHMENT_IND", sizeof(*received_message_p) );
//	MME_APP_DEBUG ( "--------------------------------\n" );
/*
 * Only for statistics Ends*/	
	...
	//if(ITTI_MSG_ID(received_message_p) != MME_APP_CONNECTION_ESTABLISHMENT_IND) //NFVEPC Project
